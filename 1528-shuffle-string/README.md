<h2><a href="https://leetcode.com/problems/shuffle-string/?envType=problem-list-v2&envId=string">1528. Shuffle String</a></h2><h3>Easy</h3><hr><p>You are given a string <code>s</code> and an integer array <code>indices</code> of the <strong>same length</strong>. The string <code>s</code> will be shuffled such that the character at the <code>i<sup>th</sup></code> position moves to <code>indices[i]</code> in the shuffled string.</p>
