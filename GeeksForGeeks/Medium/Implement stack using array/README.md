...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/implement-stack-using-array/1?page=1&category=Stack&sortBy=submissions)

## Solved On
02 Jun 2026 at 05:49 pm

<h2><a href="https://www.geeksforgeeks.org/problems/implement-stack-using-array/1?page=1&category=Stack&sortBy=submissions">Implement stack using array</a></h2><h3>Difficulty Level: Medium</h3><hr><p data-start="319" data-end="453"><span style="font-size: 14pt;">Implement a <strong data-start="331" data-end="355">Stack using an Array</strong>, where the size of the array, <strong>n</strong>&nbsp;is given.</span><br data-start="400" data-end="403"><span style="font-size: 14pt;"> The Stack must support the following operations:</span></p>
