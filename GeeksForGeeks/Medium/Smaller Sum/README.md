...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/smaller-sum--170647/1?page=2&category=Binary%20Search&sortBy=accuracy)

## Solved On
24 Jul 2026 at 06:03 pm

<h2><a href="https://www.geeksforgeeks.org/problems/smaller-sum--170647/1?page=2&category=Binary%20Search&sortBy=accuracy">Smaller Sum</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size:18px">You are given an array <strong>arr</strong> of <strong>n</strong> integers. For each index i, you have to find the sum of all integers present in the array with a value <strong>less</strong> than arr[i].</span></p>
