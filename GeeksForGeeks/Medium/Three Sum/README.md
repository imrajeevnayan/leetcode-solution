...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/three-sum/1)

## Solved On
20 May 2026 at 05:40 pm

<h2><a href="https://www.geeksforgeeks.org/problems/three-sum/1">Three Sum</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 14pt;">Given an integer array <strong>arr</strong>, return all the <strong>unique </strong>triplets [arr[i], arr[j], arr[k]] such that<strong> i != j, i != k, and j != k, </strong>and <strong>arr[i] + arr[j] + arr[k] == 0.</strong></span></p>
