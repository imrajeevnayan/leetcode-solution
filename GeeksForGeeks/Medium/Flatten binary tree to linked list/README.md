...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/flatten-binary-tree-to-linked-list/1?page=1&category=Linked%20List&sortBy=accuracy)

## Solved On
22 Jul 2026 at 09:42 pm

<h2><a href="https://www.geeksforgeeks.org/problems/flatten-binary-tree-to-linked-list/1?page=1&category=Linked%20List&sortBy=accuracy">Flatten binary tree to linked list</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 12pt;">Given the root of a binary tree, flatten the tree into a "Linked list":</span></p>
<ul>
