...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/k-largest-elements4206/1)

## Solved On
20 Aug 2026 at 06:58 pm

<h2><a href="https://www.geeksforgeeks.org/problems/k-largest-elements4206/1">k Largest Elements</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong> of positive integers and an integer <strong>k</strong>, Your task is to return k largest elements<strong> </strong>in decreasing order.&nbsp;</span></p>
...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>1 ≤ k ≤ arr.size() ≤ 10<sup>6</sup><br>1 ≤ arr[i] ≤ 10<sup>6</sup></span><br>&nbsp;</p>