...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/count-pairs-with-given-sum--150253/1)

## Solved On
20 Sept 2026 at 11:04 pm

<h2><a href="https://www.geeksforgeeks.org/problems/count-pairs-with-given-sum--150253/1">Count Pairs with Sum</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 18px;">You are given an array <strong>arr[]</strong> and an integer <strong>target</strong>. You have to count all pairs in the array such that their sum is equal to the given target.</span></p>
