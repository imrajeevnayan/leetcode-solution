...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/justified-text/1?page=1&category=Arrays&difficulty=Medium&sortBy=accuracy)

## Solved On
03 Aug 2026 at 10:43 pm

<h2><a href="https://www.geeksforgeeks.org/problems/justified-text/1?page=1&category=Arrays&difficulty=Medium&sortBy=accuracy">Justified Text</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 14pt;">Given an array of words <strong>words[]</strong> and a line width <strong>l</strong>, format the words such that each line has <strong>exactly</strong> l characters and is fully justified (both left and right).</span></p>
<ul>
