...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/rotate-a-linked-list/1)

## Solved On
04 Sept 2026 at 11:50 pm

<h2><a href="https://www.geeksforgeeks.org/problems/rotate-a-linked-list/1">Rotate a Linked List</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 14pt;">You are given the <strong>head</strong> of a singly linked list, you have to <strong>left rotate</strong> the linked list&nbsp;<strong>k</strong> times. Return the head of the modified linked list.</span></p>
...
<p><span style="font-size: 14pt;"><strong>Constraints:<br></strong></span><span style="font-size: 14pt;">1 ≤ number of nodes ≤ 10<sup>5<br></sup></span><span style="font-size: 14pt;">0 ≤ k ≤ 10<sup>9<br></sup></span><span style="font-size: 14pt;">0 ≤ node.data ≤ 10<sup>9</sup></span></p>