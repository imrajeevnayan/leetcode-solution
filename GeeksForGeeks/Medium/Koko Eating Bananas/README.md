...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/koko-eating-bananas/1)

## Solved On
02 Sept 2026 at 11:56 pm

<h2><a href="https://www.geeksforgeeks.org/problems/koko-eating-bananas/1">Koko Eating Bananas</a></h2><h3>Difficulty Level: Medium</h3><hr><p data-start="120" data-end="259"><span style="font-size: 14pt;">Koko is given an array<strong> arr[],</strong> where each element represents a pile of bananas. She has exactly <strong>k</strong>&nbsp;hours to eat all the bananas.</span></p>
