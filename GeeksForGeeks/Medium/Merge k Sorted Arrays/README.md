...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/merge-k-sorted-arrays/1)

## Solved On
22 May 2026 at 12:17 pm

<h2><a href="https://www.geeksforgeeks.org/problems/merge-k-sorted-arrays/1">Merge k Sorted Arrays</a></h2><h3>Difficulty Level: Medium</h3><hr><p class="MsoNormal"><span style="font-size: 14pt;">You are given a 2D matrix <strong>mat[][]</strong> of size <strong>n x m</strong>.<strong> </strong></span><span style="font-size: 14pt;">Each row in the matrix is sorted in <strong>non-decreasing order</strong>. Your task is to <strong>merge </strong>all the rows and return a single sorted array that contains all the elements of the matrix.</span></p>
...
<p><span style="font-size: 18px;"><strong>Constraints</strong>:<br>1 ≤ n * m ≤ 10<sup>5</sup><br>1 ≤ mat[i][j] ≤ 10<sup>6</sup></span></p>