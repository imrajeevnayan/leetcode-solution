...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/get-max-from-stack/1)

## Solved On
21 Aug 2026 at 02:42 pm

<h2><a href="https://www.geeksforgeeks.org/problems/get-max-from-stack/1">Get Max from Stack</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 18.6667px;">Implement a class <strong>SpecialStack</strong> that supports following operations:</span></p>
<ul>
...
<p><span style="font-size: 14pt;"><strong>Constraints:<br></strong></span><span style="font-size: 14pt;">1 ≤ queries.size() ≤ 10<sup>5<br></sup></span><span style="font-size: 14pt;">0 ≤ values on the stack ≤ 10<sup>9</sup></span></p>