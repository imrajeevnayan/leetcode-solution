...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/geeks-and-the-string--170645/1)

## Solved On
02 Jun 2026 at 05:43 pm

<h2><a href="https://www.geeksforgeeks.org/problems/geeks-and-the-string--170645/1">Remove Consecutive Two Same</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 18px;">Given a string <strong>s</strong>, repeatedly remove all adjacent <strong>duplicate </strong>character pairs until no such pairs remain. </span></p>
