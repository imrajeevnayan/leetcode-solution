...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/aggressive-cows/1?page=1&category=Binary%20Search&sortBy=submissions)

## Solved On
28 Jul 2026 at 02:38 pm

<h2><a href="https://www.geeksforgeeks.org/problems/aggressive-cows/1?page=1&category=Binary%20Search&sortBy=submissions">Aggressive Cows</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 18.6667px;">Given an integer array <strong>arr[]</strong>, which denotes the positions of stalls. All the positions are distinct. There are<strong> k</strong> aggressive cows.</span></p>
