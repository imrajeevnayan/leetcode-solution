...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/stack-using-queue/1)

## Solved On
06 Jun 2026 at 05:07 pm

<h2><a href="https://www.geeksforgeeks.org/problems/stack-using-queue/1">Stack using Queue</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 14pt;">Implement a&nbsp;<strong>Stack&nbsp;</strong>using Queue data structure, this stack has no fixed capacity and can grow dynamically until memory is available.<br>The Stack must support the following operations:</span></p>
