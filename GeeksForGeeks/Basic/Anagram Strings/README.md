...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/java-anagram-strings3549/1?page=5&status=unsolved&sortBy=difficulty)

## Solved On
08 Jul 2026 at 12:48 am

<h2><a href="https://www.geeksforgeeks.org/problems/java-anagram-strings3549/1?page=5&status=unsolved&sortBy=difficulty">Anagram Strings</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">Given two strings S1 and S2 . Return "1" if both strings are anagrams otherwise return "0" .</span></p>
