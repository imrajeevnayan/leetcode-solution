...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/print-alternate-elements-of-an-array/1)

## Solved On
14 Jul 2026 at 08:56 pm

<h2><a href="https://www.geeksforgeeks.org/problems/print-alternate-elements-of-an-array/1">Alternates in an Array</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">You are given an array<strong> arr[]</strong>, the task is to return a list elements of arr in alternate order (starting from index 0).</span></p>
