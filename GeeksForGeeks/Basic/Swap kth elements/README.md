...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/swap-kth-elements5500/1?page=2&status=unsolved&sortBy=difficulty)

## Solved On
07 Jul 2026 at 10:22 pm

<h2><a href="https://www.geeksforgeeks.org/problems/swap-kth-elements5500/1?page=2&status=unsolved&sortBy=difficulty">Swap kth elements</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong>, swap the <strong>k<sup>th</sup></strong> element from the beginning with the <strong>k<sup>th</sup></strong> element from the end.</span></p>
...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>1 ≤ arr.size(), k ≤ 10<sup>6</sup><br>-10<sup>9</sup> ≤ arr[i] ≤ 10<sup>9</sup></span></p>