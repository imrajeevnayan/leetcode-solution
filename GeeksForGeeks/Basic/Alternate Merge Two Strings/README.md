...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/merge-two-strings2736/1?page=1&category=Strings)

## Solved On
15 Aug 2026 at 02:29 pm

<h2><a href="https://www.geeksforgeeks.org/problems/merge-two-strings2736/1?page=1&category=Strings">Alternate Merge Two Strings</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">Given two strings <strong>s1</strong> and <strong>s2</strong>, merge them alternatively i.e. the first character of s1 then the first character of s2 and so on till the strings end.<br></span><br><span style="font-size: 18px;"><strong>Note:</strong>&nbsp;Add the whole string if other string is empty.</span></p>
