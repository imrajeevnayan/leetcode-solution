...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/smallest-number-repeating-k-times3239/1?page=3&status=unsolved&sortBy=difficulty)

## Solved On
29 Jun 2026 at 10:04 pm

<h2><a href="https://www.geeksforgeeks.org/problems/smallest-number-repeating-k-times3239/1?page=3&status=unsolved&sortBy=difficulty">Smallest Repeating K Times</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">Given an array <strong>arr</strong>, the goal is to find out the smallest number that is repeated exactly ‘<strong>k</strong>’ times.</span></p>
