...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/find-the-odd-occurence4820/1?page=1&status=unsolved&sortBy=difficulty)

## Solved On
07 Jul 2026 at 10:18 pm

<h2><a href="https://www.geeksforgeeks.org/problems/find-the-odd-occurence4820/1?page=1&status=unsolved&sortBy=difficulty">One odd Occuring</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">Given an array of <strong>arr[] </strong>positive integers where all numbers occur even number of times except one number which occurs odd number of times. Return that number.</span></p>
