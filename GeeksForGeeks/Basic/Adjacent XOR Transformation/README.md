...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/game-with-nos3123/1?page=1&category=Arrays)

## Solved On
14 Aug 2026 at 12:04 am

<h2><a href="https://www.geeksforgeeks.org/problems/game-with-nos3123/1?page=1&category=Arrays">Adjacent XOR Transformation</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">Given an array <strong>arr[] </strong>of size&nbsp;<strong>n,</strong> </span><span style="font-size: 18px;">&nbsp;transform it according to the following rule:</span></p>
<ul>
