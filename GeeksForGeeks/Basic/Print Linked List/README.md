...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/print-linked-list-elements/1?sortBy=submissions&category%5B%5D=Linked%2520List&page=1&difficulty%5B%5D=-1)

## Solved On
23 Jul 2026 at 04:46 pm

<h2><a href="https://www.geeksforgeeks.org/problems/print-linked-list-elements/1?sortBy=submissions&category%5B%5D=Linked%2520List&page=1&difficulty%5B%5D=-1">Print Linked List</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">You are given the head of a singly <strong>linked list</strong>. Return an <strong>array</strong> containing the values of the nodes.</span></p>
