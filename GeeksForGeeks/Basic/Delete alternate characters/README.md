...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/java-delete-alternate-characters4036/1?page=5&status=unsolved&sortBy=difficulty)

## Solved On
08 Jul 2026 at 12:47 am

<h2><a href="https://www.geeksforgeeks.org/problems/java-delete-alternate-characters4036/1?page=5&status=unsolved&sortBy=difficulty">Delete alternate characters</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">Given a string <strong>s</strong> as input. Delete the characters at odd indices of the string. R</span><span style="font-size: 18px;">eturn the final string after deletion of characters at odd indices.</span><br style="font-size: 18px;"><br><span style="font-size: 18px;"><strong>Examples :</strong></span></p>
