...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/fibonacci-using-recursion/1)

## Solved On
22 Aug 2026 at 08:31 pm

<h2><a href="https://www.geeksforgeeks.org/problems/fibonacci-using-recursion/1">Nth Fibonacci Using Recursion</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">Given a number <strong>n</strong>, return<strong> </strong>the<strong> n<sup>th</sup></strong> Fibonacci number.</span></p>
