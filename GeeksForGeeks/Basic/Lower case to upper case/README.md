...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/lower-case-to-upper-case3410/1?page=15&sortBy=accuracy)

## Solved On
08 Jun 2026 at 05:48 pm

<h2><a href="https://www.geeksforgeeks.org/problems/lower-case-to-upper-case3410/1?page=15&sortBy=accuracy">Lower case to upper case</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size:18px">Given a string <strong>str </strong>containing only lowercase letters, generate a string with the same letters, but in uppercase.</span></p>
