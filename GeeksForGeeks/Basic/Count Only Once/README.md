...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/count-only-once/1?page=7&sortBy=accuracy)

## Solved On
08 Jun 2026 at 05:33 pm

<h2><a href="https://www.geeksforgeeks.org/problems/count-only-once/1?page=7&sortBy=accuracy">Count Only Once</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">You are given an integer array <strong>arr[]</strong> of integers. You need to find how many elements exist if we count the elements only once. That is repeated elements are counted as occuring once.</span></p>
