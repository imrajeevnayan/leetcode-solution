...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/max-odd-sum0651/1?page=2&status=unsolved&sortBy=difficulty)

## Solved On
07 Jul 2026 at 10:20 pm

<h2><a href="https://www.geeksforgeeks.org/problems/max-odd-sum0651/1?page=2&status=unsolved&sortBy=difficulty">Max Odd Sum</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 14pt;">Given an array <strong>arr[]</strong> of integers, determine whether a subsequence exists with an odd sum. If such a subsequence exists, return the maximum possible odd sum. If no subsequence with an odd sum can be formed, return -1.</span></p>
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong></span><br><span style="font-size: 14pt;">1 ≤ arr.length ≤ 10<sup>6</sup></span><br><span style="font-size: 14pt;">-10<sup>3</sup> ≤ arr[i] ≤ 10<sup>3</sup></span></p>