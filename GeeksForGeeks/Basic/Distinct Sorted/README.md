...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/distinct-sorted--124713/1?page=2&sortBy=accuracy)

## Solved On
18 Jul 2026 at 11:52 pm

<h2><a href="https://www.geeksforgeeks.org/problems/distinct-sorted--124713/1?page=2&sortBy=accuracy">Distinct Sorted</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">Given an array <strong>arr[],</strong> return all<strong> distinct </strong>elements of the array in sorted (non-decreasing) order</span><span style="font-size: 18px;">.</span></p>
