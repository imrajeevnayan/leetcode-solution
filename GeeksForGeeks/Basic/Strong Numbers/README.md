...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/strong-numbers4336/1?page=2)

## Solved On
03 Aug 2026 at 09:22 pm

<h2><a href="https://www.geeksforgeeks.org/problems/strong-numbers4336/1?page=2">Strong Numbers</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">A Strong Number is a number whose value is equal to the sum of the factorials of its digits.</span></p>
