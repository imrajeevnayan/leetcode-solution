...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/binary-to-decimal-1611122504--161115/1?page=5&sortBy=accuracy)

## Solved On
08 Jun 2026 at 05:26 pm

<h2><a href="https://www.geeksforgeeks.org/problems/binary-to-decimal-1611122504--161115/1?page=5&sortBy=accuracy">Binary to Decimal</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 14pt;">Given a string <strong>b </strong>representing a&nbsp;</span><span style="font-size: 18.6667px;">Binary Number</span><span style="font-size: 14pt;">, The problem is to find its decimal equivalent.</span></p>
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong></span><br><span style="font-size: 14pt;">1 &lt;= number of bits in binary number&nbsp;&nbsp;&lt;= 16</span></p>