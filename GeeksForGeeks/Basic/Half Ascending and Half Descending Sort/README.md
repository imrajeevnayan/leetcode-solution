...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/sort-first-half-in-ascending-and-second-half-in-descending1714/1?page=1&status=unsolved&sortBy=difficulty)

## Solved On
07 Jul 2026 at 09:38 pm

<h2><a href="https://www.geeksforgeeks.org/problems/sort-first-half-in-ascending-and-second-half-in-descending1714/1?page=1&status=unsolved&sortBy=difficulty">Half Ascending and Half Descending Sort</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">Given an array <strong>arr </strong>of even size, sort the first half of the array in ascending order and the second half in descending order.<br></span></p>
