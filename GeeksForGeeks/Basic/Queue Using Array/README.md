...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/implement-queue-using-array/1?page=1&category=Queue&sortBy=difficulty)

## Solved On
06 Jun 2026 at 05:18 pm

<h2><a href="https://www.geeksforgeeks.org/problems/implement-queue-using-array/1?page=1&category=Queue&sortBy=difficulty">Queue Using Array</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 14pt;">Implement a <strong>Queue </strong>using an Array, where the size of the array, <strong>n</strong> is given. <br>The Queue must support the following operations:</span></p>
