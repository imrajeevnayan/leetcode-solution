...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/extract-the-integers4428/1)

## Solved On
14 Sept 2026 at 04:35 pm

<h2><a href="https://www.geeksforgeeks.org/problems/extract-the-integers4428/1">Extract Integers from String</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">Given a string<strong> s</strong> consisting of lowercase letters, uppercase letters, digits, and special characters, extract all the integers present in the string and return them in the order they appear.</span></p>
