...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/2-sum-find-a-pair-with-given-sum/1)

## Solved On
17 Sept 2026 at 11:29 pm

<h2><a href="https://www.geeksforgeeks.org/problems/2-sum-find-a-pair-with-given-sum/1">2 Sum - Find a pair with given sum</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 18px;">Given an array arr[] and an integer target, return the pair of elements whose sum equals target.&nbsp;</span><span style="font-size: 18px;">An element cannot be used twice unless it appears multiple times in the array.</span></p>
