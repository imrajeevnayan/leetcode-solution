...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/search-a-node-in-bst/1)

## Solved On
30 Aug 2026 at 11:31 pm

<h2><a href="https://www.geeksforgeeks.org/problems/search-a-node-in-bst/1">Search a node in BST</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 18px;">Given the <strong>root</strong> of a <strong>Binary Search Tree </strong>and a node value <strong>key</strong>, return <strong>true</strong> if the node with value key is present in the BST; otherwise, return <strong>false</strong>.</span></p>
...
<p><span style="font-size: 18px;"><strong>Constraints:<br></strong></span><span style="font-size: 18px;">1 ≤ number of nodes ≤ 3*10<sup>4</sup><br></span><span style="font-size: 18px;">1 ≤ node-&gt;data, key ≤ 10<sup>9</sup></span></p>