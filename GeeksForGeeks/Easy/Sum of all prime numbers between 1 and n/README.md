...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/sum-of-all-prime-numbers-between-1-and-n4404/1?page=4&category=Mathematical&sortBy=submissions)

## Solved On
03 Jun 2026 at 09:56 pm

<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-all-prime-numbers-between-1-and-n4404/1?page=4&category=Mathematical&sortBy=submissions">Sum of all prime numbers between 1 and n</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 14pt;">Given a positive integer <strong>n</strong>, compute and return the sum of all prime numbers between <strong>1</strong> and <strong>n</strong> (inclusive).</span></p>
