...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/hashing-for-pair-1--110939/1?page=1&category=Hash&sortBy=accuracy)

## Solved On
08 Aug 2026 at 10:05 pm

<h2><a href="https://www.geeksforgeeks.org/problems/hashing-for-pair-1--110939/1?page=1&category=Hash&sortBy=accuracy">Hashing for pair - 1</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 18px;">You are given an array of <strong>distinct</strong> integers&nbsp;and&nbsp;a <strong>sum</strong>. Check if there's a pair with the given sum in the array.</span></p>
