...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/implement-stack-using-linked-list/1?page=1&category=Stack&status=unsolved&sortBy=submissions)

## Solved On
05 Jun 2026 at 10:01 am

<h2><a href="https://www.geeksforgeeks.org/problems/implement-stack-using-linked-list/1?page=1&category=Stack&status=unsolved&sortBy=submissions">Stack using Linked List</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 14pt;"><span style="font-size: 18.6667px;">Implement a <strong>Stack </strong>using a Linked List. The stack has dynamic size and can grow until memory is available.</span><br><span style="font-size: 14pt;">The Stack must support the following operations:</span></span></p>
