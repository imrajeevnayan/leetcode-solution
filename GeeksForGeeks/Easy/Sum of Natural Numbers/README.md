...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/reverse-coding2452/1?page=1&status=unsolved&sortBy=submissions)

## Solved On
03 Jun 2026 at 09:55 pm

<h2><a href="https://www.geeksforgeeks.org/problems/reverse-coding2452/1?page=1&status=unsolved&sortBy=submissions">Sum of Natural Numbers</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 14pt;">Given an integer <strong>n</strong>, your task is to compute the sum of all natural numbers from 1 to n (inclusive). If n is 0, the sum should be 0.</span></p>
