...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/insert-an-element-at-the-bottom-of-a-stack/1?page=3&category=Stack&sortBy=submissions)

## Solved On
03 Jun 2026 at 12:10 am

<h2><a href="https://www.geeksforgeeks.org/problems/insert-an-element-at-the-bottom-of-a-stack/1?page=3&category=Stack&sortBy=submissions">Insert an Element at the Bottom of a Stack</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 18px;">You are given a stack <strong>st</strong> of <strong>n</strong> integers and an element <strong>x</strong>. You have to insert <strong>x</strong> at the bottom of the given stack.&nbsp;</span></p>
