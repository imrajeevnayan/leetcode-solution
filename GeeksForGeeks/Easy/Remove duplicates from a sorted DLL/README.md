...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/remove-duplicates-from-a-sorted-doubly-linked-list/1?page=2&category=Linked%20List&status=unsolved&sortBy=difficulty)

## Solved On
31 May 2026 at 01:09 am

<h2><a href="https://www.geeksforgeeks.org/problems/remove-duplicates-from-a-sorted-doubly-linked-list/1?page=2&category=Linked%20List&status=unsolved&sortBy=difficulty">Remove duplicates from a sorted DLL</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 18px;">Given a doubly&nbsp;linked list of <strong>n </strong>nodes sorted by values, remove duplicate nodes present in the linked list.</span></p>
