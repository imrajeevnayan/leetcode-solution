...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/find-the-frequency/1?page=3&sortBy=submissions)

## Solved On
11 Jul 2026 at 12:15 pm

<h2><a href="https://www.geeksforgeeks.org/problems/find-the-frequency/1?page=3&sortBy=submissions">Find the Frequency</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 18px;">Given an array <strong>a</strong><strong>rr</strong> of positive integers and an integer <strong>x</strong>. Return the <strong>frequency </strong>of&nbsp;<strong>x</strong> in the array.</span></p>
