...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/all-divisors-of-a-number/1)

## Solved On
28 Jun 2026 at 05:48 pm

<h2><a href="https://www.geeksforgeeks.org/problems/all-divisors-of-a-number/1">All divisors of a Number</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 18px;">Given an integer <strong>n,</strong> return all the divisors of n in the <strong>ascending </strong>order.</span><br>&nbsp;<br><span style="font-size: 18px;"><strong>Examples:</strong></span></p>
