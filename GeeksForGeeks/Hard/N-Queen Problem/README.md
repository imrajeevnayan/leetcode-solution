...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/n-queen-problem0315/1?page=3&category=Backtracking&sortBy=difficulty)

## Solved On
22 May 2026 at 03:42 pm

<h2><a href="https://www.geeksforgeeks.org/problems/n-queen-problem0315/1?page=3&category=Backtracking&sortBy=difficulty">N-Queen Problem</a></h2><h3>Difficulty Level: Hard</h3><hr><p><span style="font-size: 18px;">The&nbsp;<strong>n</strong>-queens puzzle is the problem of placing n queens on a&nbsp;(<strong>n × n)</strong>&nbsp;chessboard such that no two queens can attack each other. Note that two queens attack each other if they are placed on the same row, the same column, or the same diagonal.</span></p>
