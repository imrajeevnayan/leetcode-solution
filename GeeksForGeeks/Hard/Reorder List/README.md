...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/reorder-list/1)

## Solved On
06 Sept 2026 at 12:08 am

<h2><a href="https://www.geeksforgeeks.org/problems/reorder-list/1">Reorder List</a></h2><h3>Difficulty Level: Hard</h3><hr><p><span style="font-size: 14pt;">Given a singly linked list<em>: </em>A<sub>0 </sub>→A<sub>1</sub> →...→A<sub>n-2 </sub>→A<sub>n-1 </sub>, reorder it to A<sub>0</sub> →A<sub>n-1</sub> →A<sub>1</sub> →A<sub>n-2 </sub>→A<sub>2 </sub>→A<sub>n-3</sub> →...</span><br><span style="font-size: 14pt;"><span style="font-size: 14pt;">For example: Given 1-&gt;2-&gt;3-&gt;4-&gt;5 its reorder is 1-&gt;5-&gt;2-&gt;4-&gt;3.</span></span></p>
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong></span><br><span style="font-size: 14pt;">1 &lt;= no. of nodes &lt;= 10<sup>6</sup></span><br><span style="font-size: 14pt;">0 &lt;= node-&gt;data &lt;= 10<sup>6</sup></span></p>