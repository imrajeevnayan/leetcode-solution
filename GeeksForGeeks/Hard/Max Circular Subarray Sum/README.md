...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/max-circular-subarray-sum-1587115620/1?page=1&category=Kadane)

## Solved On
15 Aug 2026 at 02:26 pm

<h2><a href="https://www.geeksforgeeks.org/problems/max-circular-subarray-sum-1587115620/1?page=1&category=Kadane">Max Circular Subarray Sum</a></h2><h3>Difficulty Level: Hard</h3><hr><p><span style="font-size: 14pt;">You are given a circular array&nbsp;<strong><code data-start="48" data-end="55">arr[]</code>&nbsp;</strong>of integers, find the&nbsp;<strong>maximum</strong>&nbsp;possible sum of a non-empty&nbsp;<strong>subarray</strong>. In a circular array, the subarray can start at the end and wrap around to the beginning. Return the maximum non-empty subarray sum, considering both non-wrapping and wrapping cases.</span></p>
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong><br>1 ≤ arr.size() ≤ 10<sup>5</sup><br>-10<sup>4 </sup>≤ arr[i] ≤ 10<sup>4</sup></span></p>